...
class msgCode(Enum):
    ...
    TEAM_NO_ONE = ("TEAM_NO_ONE", "群聊查无此人")
    TEAM_ADD_SUCCESS = ("TEAM_ADD_SUCCESS", "添加到队伍成功")
    TEAM_RM_SUCCESS = ("TEAM_RM_SUCCESS", "从队伍删除成功")
    TEAM_IN_LOCK = ("TEAM_IN_LOCK", "有人已锁定角色卡")
    TEAM_LIST = ("TEAM_LIST", "查看队伍列表")
    TEAM_SHOW = ("TEAM_SHOW", "查看队员属性")
    TEAM_CLR = ("TEAM_CLR", "解散队伍")
    TEAM_CALL = ("TEAM_CALL", "鸽子召集")
    TEAM_PROP = ("TEAM_PROP", "调整队员属性")
    TEAM_LOCK_SUCCESS = ("TEAM_LOCK_SUCCESS", "全队锁卡成功")
    TEAM_LOCK_FAIL = ("TEAM_LOCK_FAIL", "全队锁卡失败")
